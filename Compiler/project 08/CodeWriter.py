...
class CodeWriter:
    ...
    def __init__(self, output_stream: typing.TextIO) -> None:
        ...
        self.comp_num = 0  # to insure that we jump to the right label.
        self.function_counter = 0  # to insure that we jump to the right label.
    ...
    def push_constant(self, index: int):
        # *sp = index
        self.output_file.write("//push constant: \n")
    ...
    def create_decorated_label(self, label: str) -> str:
        return self.current_function + "$" + label + str(self.label_counter)
    ...
    def write_label(self, label: str) -> None:
        ...
        self.output_file.write("//creates new label:\n")
        self.output_file.write("(" + self.create_decorated_label(label) + ")\n")
    ...
    def write_goto(self, label: str) -> None:
        ...
        # This is irrelevant for project 7,
        # you will implement this in project 8!
        decorated_label = self.create_decorated_label(label)
        self.output_file.write("@" + decorated_label + "\n0;JMP\n")
    ...
    def write_if(self, label: str) -> None:
        ...
        # This is irrelevant for project 7,
        # you will implement this in project 8!
        self.output_file.write("// begin if-goto process: \n")
        self.pop_from_stack()
        self.output_file.write("@" + self.create_decorated_label(label) + "\n")
    ...
    def generate_ret_addr(self, function_name: str, func_num: int) -> str:
        """
        Creates the symbol "Xxx.foo$ret.i" for the function "write_call".
        """
        return function_name + "$ret." + str(func_num)
    ...
    def write_call(self, function_name: str, n_args: int) -> None:
        ...
        # push return address
        generated_name = self.generate_ret_addr(function_name, self.function_counter)
        self.output_file.write("@" + generated_name + "\nD=A\n")
        self.push_to_stack()
        ...
        # ARG = SP - 5 - nargs
        self.output_file.write("//ARG=SP-5-n_args:\n")
        subtraction_value = 5 + n_args
        self.output_file.write("@SP\nD=M\n@" + str(subtraction_value) + "\nD=D-A\n")
        self.output_file.write("@ARG\nM=D\n")

        # LCL = SP
        self.output_file.write("//LCL=SP:\n")
        self.output_file.write("@SP\nD=M\n@LCL\nM=D\n")

        # goto function_name
        self.output_file.write("//goto function:\n")
    ...
    def restore_segment_address(self, index: int, segment: str) -> None:
        self.output_file.write("//set back "+segment+":\n")
    ...
    def write_return(self) -> None:
        ...
        self.output_file.write("//set return address: \n"
                               "@frame\nD=M\n@5\nA=D-A\nD=M\n")
        self.output_file.write("@return_address\nM=D\n")

        # set ARG
        self.pop_from_stack()
        self.output_file.write("//set ARG:\n"
                               "@ARG\nA=M\nM=D\n") #added A=M in the middle
        # set SP
        self.output_file.write("//set SP:\n"
                               "@ARG\nD=M+1\n")
        self.output_file.write("@SP\nM=D\n")

        switch = {1: "THAT", 2: "THIS", 3: "ARG", 4: "LCL"}
        for i in range(1, 5):
            self.restore_segment_address(i, switch[i])
        self.output_file.write("// goto return address:"
                               "\n@return_address\nA=M\n0;JMP\n")
